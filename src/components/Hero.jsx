...
const Hero = () => {
  return (
    <section className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative z-20 h-screen flex items-center">
      <div className="flex flex-col-reverse md:flex-row items-center justify-between w-full gap-10">
        ...
        <div className="max-w-xl text-center md:text-left">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight text-white drop-shadow-md">
            ...
            <span className="block max-w-[312px] mx-auto md:mx-0">One Card at a Time</span>
          </h1>

    ...
    return (
        <section className="py-16 px-4">
            <div className="container mx-auto text-center">
                <h2 className="text-4xl md:text-5xl font-bold mb-8">Bulk Orders & Wholesale</h2>
                <p className="text-gray-300 text-lg mb-16 max-w-3xl mx-auto">
                    Are you a school, bookstore, yoga studio, parenting group, or retailer looking to inspire children and
                    families with values, mindfulness, and cultural richness?
                </p>
